...
export default function FirebaseAuthPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-amber-500 to-orange-600 p-4 rounded-2xl shadow-lg">
                  <Currency className="h-10 w-10 text-white" />
                </div>
              </div>
            </div>
            <h1 className="text-3xl font-bold tracking-tight text-white">Dashboard de Trading</h1>
            ...
            <CardContent className="p-8">
              {firebaseEnabled !== false && (
                <>
                  <Button 
                    variant="outline" 
                    className="w-full h-12 mb-6 bg-white hover:bg-slate-100 text-slate-900 border-0 font-medium"
                  ...
                  <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-slate-800/50 px-3 text-slate-500">o continúa con email</span>
                    </div>
                  </div>
                </>
              )}
              ...
              <Tabs 
                ...
                className="w-full"
              >
                <TabsList className="grid grid-cols-2 w-full mb-6 h-11 bg-slate-700/50">
                  <TabsTrigger 
                    value="login" 
                    className="text-sm font-medium data-[state=active]:bg-amber-500 data-[state=active]:text-white"
                ...
                <TabsContent value="login" className="space-y-4 mt-0">
                  <Form {...loginForm}>
                    <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                            ...
                            <FormControl>
                              <div className="relative">
                                ...
                                <Input 
                                  ...
                                  className="pl-10 h-11 bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-500 focus:border-amber-500"
                            ...
                            <FormControl>
                              <div className="relative">
                                ...
                                <Input 
                                  ...
                                  placeholder="••••••••" 
                                  className="pl-10 pr-10 h-11 bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-500 focus:border-amber-500"
                                ...
                                <Button
                                  ...
                                  variant="ghost"
                                  size="sm"
                                  className="absolute right-1 top-1 h-9 w-9 text-slate-400 hover:text-white hover:bg-slate-600"
                      ...
                      <Button 
                        type="submit" 
                        className="w-full h-11 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-medium"
                  ...
                  <Form {...registerForm}>
                    <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-slate-300">Nombre de Usuario</FormLabel>
                            <FormControl>
                              <div className="relative">
      ...
      <div className="flex-1 bg-gradient-to-br from-amber-600 via-orange-600 to-red-700 p-8 text-white hidden lg:flex lg:flex-col lg:justify-center relative overflow-hidden">
        ...
        <div className="relative max-w-lg mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Trading Profesional</h2>
